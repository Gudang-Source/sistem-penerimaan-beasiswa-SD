            ...
            <div class="panel panel-danger">
                ...
                <div class="panel-body">
                    <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th width="10%">Kelas</th><th>Nama Siswa</th><th>Nis</th><th width="17%">Tgl. Penerimaan</th><th>Jumlah</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="report/arsip_satu.php?id=<?= $data['id'] ?>" target="_blank" class="btn btn-danger btn-xs">
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="9">
                                    <a href="report/arsip_semua.php" target="_blank" class="btn btn-danger btn-sm">
                                        <span class="fa fa_print"></span> Cetak Semua Arsip

                                    </a>
                                    <a href="#cetak_perbulan" class="btn btn-danger btn-sm">
                                        <span class="fa fa_print"></span> Cetak Perbulan

                                    </a>
                                    <a href="#cetak_pertahun" class="btn btn-danger btn-sm">
