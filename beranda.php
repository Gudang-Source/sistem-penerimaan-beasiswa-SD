    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-danger">
                <strong>Selamat Datang di SI Penerimaan Beasiswa SDN 1 Air Batu</strong>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-9 col-xs-12">
            <div class="panel panel-defalut">
                ...
                <div class="panel-body">
                     ...
                     <h3 align="center">SD NEGRI 1 AIR BATU</h3>
                </div>
            </div>
        </div>
        <!--akhir colomn kedua-->
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                <button type="submit" name="login" value="login"
                                        class="btn btn-danger btn-block"><span class="fa fa-unlock-alt"></span>
                                    Login Sistem
                                </button>
                            </div>
                    </form>
